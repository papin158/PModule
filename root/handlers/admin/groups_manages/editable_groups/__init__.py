...
async def edit_groups(call: types.CallbackQuery, callback_data: SuperUserMenu, state: FSMContext, **kwargs):
...
async def select_choice_group_or_subgroup_edit(call: types.CallbackQuery, callback_data: SuperUserMenu,
                                               state: FSMContext):
